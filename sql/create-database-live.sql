-- =====================================================
-- Operational Excellence App - LIVE/Production Database Setup
-- Database: OEApp_Live
...
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = 'OEApp_Live')
BEGIN
    CREATE DATABASE OEApp_Live;
    PRINT 'Database OEApp_Live created successfully';
END
ELSE
BEGIN
    PRINT 'Database OEApp_Live already exists';
END
GO
...
PRINT '';
PRINT '=====================================================';
PRINT '  OEApp_Live Database Setup Complete!';
PRINT '  Environment: PRODUCTION';
PRINT '  URL: https://oeapp.gmrlapps.com';
PRINT '=====================================================';
